...
const PAGES = {
  bible: {
    title: 'الكتاب المقدس', icon: 'fas fa-book-bible',
  ...
  prayers: {
    title: 'الصلوات والأجبية', icon: 'fas fa-hands-praying',
  ...
  fathers: {
    title: 'آباء الكنيسة القبطية', icon: 'fas fa-comment-dots',
  ...
  hymns: {
    title: 'الترانيم الكنسية القبطية', icon: 'fas fa-headphones',
  ...
  radio: {
    title: 'إذاعة مسيحية', icon: 'fas fa-tower-broadcast',
  ...
  mass: {
    title: 'مواعيد القداسات', icon: 'fas fa-church',
  ...
  rosary: {
    title: 'المسبحة الإلكترونية', icon: 'fas fa-circle-dot',
  ...
  saints: {
    title: 'قديسو الكنيسة القبطية', icon: 'fas fa-star',
  ...
  tafsir: {
    title: 'التفسير والتأمل', icon: 'fas fa-book-open-reader',
  ...
  encyclopedia: {
    title: 'الموسوعة القبطية', icon: 'fas fa-landmark',
...
function openPage(id) {
  // إذا كان المعرف هو عن التطبيق، يتم تشغيل دالة openAbout مباشرة
  if (id === 'about') {
    openAbout();
    return;
  }
...
/* دالة عن التطبيق - نسخة محسنة ومحدثة */
function openAbout() {
  document.getElementById('mbox').innerHTML =
    `<div class="m-head">
      <div class="m-ttl"><i class="fas fa-circle-info"></i> عن التطبيق</div>
      <button class="m-close" onclick="closeModal()"><i class="fas fa-xmark"></i></button>
    </div>
    <div class="m-body" style="padding: 10px 5px;">
      
      <!-- بطاقة تعريفية بالتطبيق -->
      <div style="background: var(--bg2); border: 1px solid var(--bd); border-radius: 12px; padding: 16px; margin-bottom: 16px; text-align: center;">
        <div style="width: 60px; height: 60px; background: rgba(var(--ac-rgb), 0.1); color: var(--ac); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 12px; font-size: 24px;">
          ☩
        </div>
        <h3 style="font-size: 16px; font-weight: 800; color: var(--t1); margin-bottom: 8px;">Soft Christian</h3>
        <p style="font-size: 12.5px; color: var(--t2); line-height: 1.7; text-align: justify; text-align-last: center; margin: 0;">
          منصة قبطية أرثوذكسية تفاعلية مصممة بدقة لتلبية الاحتياجات الروحية والطقسية اليومية، وتجميع كلمة الله والتراث الكنسي الحي في واجهة رقمية واحدة مبسطة وسريعة الاستجابة.
        </p>
      </div>

      <!-- بطاقة المطور والجهة المنفذة -->
      <div style="background: var(--bg2); border: 1px solid var(--bd); border-radius: 12px; padding: 16px; margin-bottom: 16px;">
        <span style="font-size: 10px; font-weight: 800; background: var(--ac); color: var(--bg0); padding: 3px 8px; border-radius: 6px; display: inline-block; margin-bottom: 12px;">المطور والناشر</span>
        
        <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 10px;">
          <div style="width: 42px; height: 42px; background: var(--bg3); border: 1px solid var(--bd); border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 18px; color: var(--t1);">
            <i class="fas fa-code"></i>
          </div>
          <div>
            <h4 style="font-size: 14px; font-weight: 800; color: var(--t1); margin: 0;">نبيل نجيب</h4>
            <span style="font-size: 11px; color: var(--t3);">مؤسس ومطور منصة Soft Web</span>
          </div>
        </div>
        
        <p style="font-size: 12px; color: var(--t2); line-height: 1.6; margin: 0 0 14px 0;">
          تم بناء هذا المشروع بأحدث تقنيات الويب لضمان أداء سلس وتجربة مستخدم مريحة للعين أثناء القراءة والتصفح اليومي.
        </p>

        <!-- أزرار التواصل -->
        <div style="display: flex; gap: 8px;">
          <a href="https://nabilnagib201.github.io/softweb/" target="_blank" style="flex: 1; text-align: center; background: var(--bg3); border: 1px solid var(--bd); color: var(--t1); padding: 8px; border-radius: 8px; font-size: 12px; font-weight: 700; text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 6px; transition: background 0.2s;">
            <i class="fas fa-globe" style="color: var(--ac);"></i> موقع الشركة
          </a>
          <a href="https://github.com/nabilnagib201" target="_blank" style="flex: 1; text-align: center; background: var(--bg3); border: 1px solid var(--bd); color: var(--t1); padding: 8px; border-radius: 8px; font-size: 12px; font-weight: 700; text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 6px; transition: background 0.2s;">
            <i class="fab fa-github"></i> حساب GitHub
          </a>
        </div>
      </div>

      <!-- تذييل الإصدار -->
      <div style="text-align: center; font-size: 10.5px; color: var(--t3);">
        الإصدار الحالي v1.0.0 • جميع الحقوق محفوظة © ٢٠٢٦
      </div>
